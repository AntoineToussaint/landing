    ...
    <>
      <div className="mb-4">
        ...
        <span className="font-light text-gray-500 text-sm hidden">
          Some form description text here
        </span>
      </div>
      <form
...
const labelClassName = "text-muted text-[14px] font-light mb-2";

const errorClassName = "text-[14px] text-red-500 font-light mt-1";

const fieldClassName =
  "h-[42px] border border-neutral-900 bg-neutral-900 rounded-lg px-4 py-2 w-full text-[14px] placeholder:text-neutral-700 focus:outline-none focus:border-neutral-800";
